 ...
 * @author dengyong
 */
var measureImage = 'marker2.png'; // 测距的点图标
var poly;
...
function completeMeasure() {
	...
	if (measureMarkerArray.length > 0) {
		...
		var marker = new MarkerWithLabel({
			...
			icon : "dd-end.png",
			map : map,
			labelContent : '总长：' + lastMarker.labelContent
					+ '<img onclick="deleteOverlays(' + removeIndex
					+ ');" src="close.png" style="padding-top:0.1em;"/></div>',
